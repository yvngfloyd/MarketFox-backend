...
Формат ОТВЕТА (очень важно, строго соблюдай):
1) Сначала дай КРАТКОЕ ОПИСАНИЕ документа и его ключевых условий (до 8–10 предложений).
   Это должна быть выжимка по сути: что за договор, какие основные условия, на что обратить внимание.
2) Затем напиши ОТДЕЛЬНОЙ строкой три дефиса:
   ---
3) После строки с тремя дефисами выведи ПОЛНЫЙ ТЕКСТ черновика договора в деловом стиле, так как он должен выглядеть в документе.

Не подписывай блоки словами «краткое описание» или «полный текст», не поясняй структуру —
...
Не подписывай блоки, не объясняй структуру: просто сначала обзор, затем строка --- , затем полный текст.
"""
